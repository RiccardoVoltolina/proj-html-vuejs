    ...
    data() {
        return {
            footerInfos: [
                ...
                {//card2
                    h3: 'Help',
                    a: ['Faqs', 'Teams & Conditions', 'Privacy',]
                },
                {//card3
                    h3: 'Follow Us',
                    a: ['Feedback', 'Twitter', 'Instagram', 'Youtube', 'Github']
                },
            ],
            FooterInfoContacts: [
                {//card4
...
<template>
    <footer class="">
        <div class="container w-75">
            <div class="row pb_5rem">
                <div class="col-4 d-flex flex-column">
                    <div>
                        <img src="../assets/images/header-images/header logo.png" alt="">
                    </div>
                    <p class="py-3 font_size_12">Lorem ipsum dolor sit amet,elit,varius enim in eros elementum Duis mi quis
                        viverra
                        ornare</p>
                    <div class="d-flex">
                        ...
                        <div class="d-flex footer_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-twitch"
                                viewBox="0 0 16 16">
                                <path
